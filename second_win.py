...
from PyQt5.QtWidgets import (
    QHBoxLayout, QWidget, QHBoxLayaut, QVBoxLayout,
...
class TestWin(QWidget):
    ...
    def initUI(self):
        ...
        self.text_next = QLabel(txt_name)
        ...
        self.r_line.addWidget(self.text_next, alignment=Qt.AlignCenter)
    ...
    def next_click(self):
        ...
        try:
            ...
            edad = int(self.line_age.text()) if self.line_age.text().isdigit() else 0
        except ValueError:
            edad = 0
